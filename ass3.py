"""
    ...
    @Author:    Ian Wheeler; 2/24/17; <wheeler.i5971@gmail.com>
    ------------------------------------------------------------------------
    IDE:        PyCharm CE
    ------------------------------------------------------------------------
    Title:      Assignment #3
    ------------------------------------------------------------------------
    Dataset:    ass3input.txt, ransac_data.txt
    ------------------------------------------------------------------------
    Source:     Xuqing Wu; University of Houston
    ------------------------------------------------------------------------
    Objective:  Implement the RANSAC algorithm for linear regression
...
def ransac(observed_data, threshold):
    """
    observed_data:  the set of observed data for fitting a linear regression 
                    model.
